...
Este projeto implementa um sistema básico de login utilizando HTML + JavaScript, onde um usuário informa seu nome e senha, e o sistema verifica se ele existe em uma lista pré-cadastrada.
